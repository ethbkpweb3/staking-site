! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "296375e9-57c2-4a81-a5b7-0d633f5b0381", e._sentryDebugIdIdentifier = "sentry-dbid-296375e9-57c2-4a81-a5b7-0d633f5b0381")
    } catch (e) {}
}();
"use strict";
...
Missing signature for public key${1===e.missing.length?"":"(s)"} [\`${e.missing.map(e=>e.toBase58()).join("`, `")}\`].`), Error(t)
            ...
            class eT {
                ...
                static transfer(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = eS(eB.TransferWithSeed, {
                ...
                static assign(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = eS(eB.AssignWithSeed, {
                ...
                static nonceInitialize(e) {
                    let t = eS(eB.InitializeNonceAccount, {
                ...
                static nonceAdvance(e) {
                    let t = eS(eB.AdvanceNonceAccount);
                    return new eo({
                        keys: [{
                            pubkey: e.noncePubkey,
                            isSigner: !1,
                ...
                static nonceWithdraw(e) {
                    let t = eS(eB.WithdrawNonceAccount, {
                        lamports: e.lamports
                    });
                    return new eo({
                        keys: [{
                ...
                static nonceAuthorize(e) {
                    let t = eS(eB.AuthorizeNonceAccount, {
                ...
                static allocate(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = eS(eB.AllocateWithSeed, {
                        base: v(e.basePubkey.toBuffer()),
                        seed: e.seed,
                        space: e.space,
                        programId: v(e.programId.toBuffer())
            ...
            class eO {
                ...
                static async load(e, t, r, i, n) {
                    ...
                    for (; u.length > 0;) {
                        ...
                        l.push(ek(e, h, [t, r], {
                            commitment: "confirmed"
                        })), e._rpcEndpoint.includes("solana.com") && await ew(250), c += a, u = u.slice(a)
                    }
                    await Promise.all(l); {
            ...
            let e4 = (0, y.dt)({
                ...
                tR = (0, y.oQ)((0, y.G0)([(0, y.eE)(s.Buffer), tw]), (0, y.G0)([eZ, tw]), e => Array.isArray(e) ? (0, y.Ue)(e, eX) : e),
                tx = (0, y.dt)({
                    executable: (0, y.O7)(),
                    owner: eF,
                    lamports: (0, y.Rx)(),
            ...
            class rw {
                    ...
                    this._commitment = void 0, this._confirmTransactionInitialTimeout = void 0, this._rpcEndpoint = void 0, this._rpcWsEndpoint = void 0, this._rpcClient = void 0, this._rpcRequest = void 0, this._rpcBatchRequest = void 0, this._rpcWebSocket = void 0, this._rpcWebSocketConnected = !1, this._rpcWebSocketHeartbeat = null, this._rpcWebSocketIdleTimeout = null, this._rpcWebSocketGeneration = 0, this._disableBlockhashCaching = !1, this._pollingBlockhash = !1, this._blockhashInfo = {
                        ...
                        return null != s && console.warn("You have supplied an `httpAgent` when creating a `Connection` in a browser environment.It has been ignored; `httpAgent` is only used in Node environments."), i && (a = async (e, t) => {
                            ...
                            try {
                                let t, r = 5,
                                    o = 500;
                                for (; t = a ? await a(e, s) : await c(e, s), 429 === t.status && !0 !== n && (r -= 1, 0 !== r);) console.error(`Server responded with ${t.status} ${t.statusText}.  Retrying after ${o}ms delay...`), await ew(o), o *= 2;
                                let u = await t.text();
                    ...
                    let n, s = !1,
                        o = new Promise(t => {
                            ...
                            (async () => {
                                ...
                                if (!s) {
                                    for (; e <= r;)
                                        if (await ew(1e3), s || (e = await i(), s)) return;
                                    t({
                            ...
                            (async () => {
                                if (s = await c(), !a)
                                    for (;;) {
                                        ...
                                        if (await ew(2e3), a || (s = await c(), a)) return
                                    }
                            })()
                        }),
                        {
                ...
                async _blockhashWithExpiryBlockHeight(e) {
                    if (!e) {
                        for (; this._pollingBlockhash;) await ew(100);
            ...
            class rS {
                ...
                static fromSeed(e) {
                    let t = A(e),
                        r = new Uint8Array(64);
                    return r.set(e), r.set(t, 32), new rS({
                        publicKey: t,
                        secretKey: r
                    })
                }
            ...
            class rA {
                ...
                static createLookupTable(e) {
                    let [t, r] = W.findProgramAddressSync([e.authority.toBuffer(), (0, p.k$)(BigInt(e.recentSlot), 8)], this.programId), i = eS(r_.CreateLookupTable, {
                ...
                static deactivateLookupTable(e) {
                    let t = eS(r_.DeactivateLookupTable),
                        r = [{
                            pubkey: e.lookupTable,
                            isSigner: !1,
                            isWritable: !0
            ...
            class rP {
                ...
                static requestHeapFrame(e) {
                    let t = eS(rx.RequestHeapFrame, e);
                    return new eo({
                        keys: [],
                        programId: this.programId,
                        data: t
                ...
                static setComputeUnitLimit(e) {
                    let t = eS(rx.SetComputeUnitLimit, e);
                    return new eo({
                        keys: [],
                        programId: this.programId,
                        data: t
                ...
                static setComputeUnitPrice(e) {
                    let t = eS(rx.SetComputeUnitPrice, {
            ...
            class rO {
                ...
                static publicKeyToEthAddress(e) {
                    ...
                    try {
                        return s.Buffer.from((0, w.fr)(v(e))).slice(-20)
                    } catch (e) {
            ...
            class rq {
                ...
                static initialize(e) {
                    let {
                        ...
                        authorized: r,
                        lockup: i
                    } = e, n = i || rK.default, s = eS(rz.Initialize, {
                        authorized: {
            ...
            class rJ {
                ...
                static updateValidatorIdentity(e) {
                    let {
                        ...
                        authorizedWithdrawerPubkey: r,
                        nodePubkey: i
                    } = e, n = eS(rj.UpdateValidatorIdentity);
                    return new ea().add({
                        keys: [{
                            pubkey: t,
                            isSigner: !1,
