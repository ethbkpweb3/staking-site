! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "9c552b33-4f1f-4640-a15c-26cefe63f2bc", e._sentryDebugIdIdentifier = "sentry-dbid-9c552b33-4f1f-4640-a15c-26cefe63f2bc")
    } catch (e) {}
}();
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [4978], {
        57837: function(e, t, s) {
            s.d(t, {
                ConfigCtrl: function() {
                    return O
                },
            ...
            let r = Symbol(),
                ...
                [p] = ((e = Object.is, t = (e, t) => new Proxy(e, t), s = e => c(e) && !u.has(e) && (Array.isArray(e) || !(Symbol.iterator in e)) && !(e instanceof WeakMap) && !(e instanceof WeakSet) && !(e instanceof Error) && !(e instanceof Number) && !(e instanceof Date) && !(e instanceof String) && !(e instanceof RegExp) && !(e instanceof ArrayBuffer), r = e => {
                    ...
                    return i(l, !0), n.set(e, [t, l]), Reflect.ownKeys(e).forEach(t => {
                        ...
                        W = {
                            ...
                            set(t, r, n, o) {
                                let i = Reflect.has(t, r),
                                    p = Reflect.get(t, r, o);
                                if (i && (e(p, n) || a.has(n) && e(p, a.get(n)))) return !0;
                                I(r), c(n) && (n = l(n) || n);
                                let h = n;
                                if (n instanceof Promise) n.then(e => {
                                    n.status = "fulfilled", n.value = e, g(["resolve", [r], e])
                                }).catch(e => {
                                    n.status = "rejected", n.reason = e, g(["reject", [r], e])
                                });
                                else {
                                    !d.has(n) && s(n) && (h = f(n));
            ...
            let $ = b.isMobile(),
                ...
                H = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (b.isArray(e)) {
                            ...
                            let {
                                chains: e,
                                isAuth: s
                            } = I.state, r = e ? .join(","), n = b.isArray(t), o = {
                                page: 1,
                    ...
                    async getWallets(e) {
                        ...
                        n.length ? t.excludedIds = n.map(e => e.id).join(",") : b.isArray(s) && (t.excludedIds = s.join(",")), b.isArray(r) && (t.excludedIds = [t.excludedIds, r].filter(Boolean).join(",")), I.state.isAuth && (t.sdks = "auth_v1");
                        let {
                            page: o,
                            search: a
                        } = e, {
                            listings: l,
                            total: i
                        } = $ ? await P.getMobileListings(t) : await P.getDesktopListings(t), c = Object.values(l), d = a ? "search" : "wallets";
                        return V[d] = {
        ...
        44978: function(e, t, s) {
            ...
            class n {
                ...
                async initUi() {
                    if ("u" > typeof window) {
                        await s.e(6275).then(s.bind(s, 46275));
